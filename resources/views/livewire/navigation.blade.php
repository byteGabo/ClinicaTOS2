    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            {{-- Logotipo --}}
          <a href="/" class="flex-shrink-0 flex items-center text-white text-xl">
            <strong class="font-extrabold">Go</strong>Clinic
          </a>
          ...
          <div class="hidden sm:block sm:ml-6">
            <div class="flex space-x-4">
              ...
              <a href="{{route('doctors.category', $category)}}" class="text-gray-300 hover:bg-gray-700  hover:text-white px-3 py-2 rounded-md text-sm font-medium">{{$category->name_category}}</a>
              @endforeach
    ...
    <div x-on:click.away="open=false" class="sm:hidden" id="mobile-menu" x-show="open">
      <div class="px-2 pt-2 pb-3 space-y-1">
       ...
       {{--  <a href="#" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">Dashboard</a> --}}
        @foreach ($categories as $category)
        <a href="{{route('doctors.category', $category)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">{{$category->name_category}}</a>
        @endforeach
