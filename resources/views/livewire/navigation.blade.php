    ...
    <div x-on:click.away="open=false" class="sm:hidden" id="mobile-menu" x-show="open">
      <div class="px-2 pt-2 pb-3 space-y-1">
       ...
       {{--  <a href="#" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">Dashboard</a> --}}
        @foreach ($categories as $category)
        <a href="{{route('doctors.category', $category)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">{{$category->name}}</a>
        @endforeach
